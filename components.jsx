...
const KAVBUG_VERSION = "3.13";

// יומן שינויים — מוצג בלחיצה על מספר הגרסה. הראש = הגרסה הנוכחית.
const CHANGELOG = [
  { version: "3.13", date: "13.6.2026", items: [
    "תוקנה רגרסיה מ-3.10: הסינון שהוסף לגלאי-הלולאה (פסילת קו-ייחוס לפי מרחק-מוצא/כיוון) מחק בטעות לולאות אמיתיות — הוחזר. קווים כמו 67 ו-50 מסומנים שוב כראוי. הקו-הירוק (מסלול קו-הייחוס) ממשיך להופיע גם עבור לולאות.",
  ] },
  ...
  { version: "1.3.9", date: "13.6.2026", items: [
    "תוקן: קו-ייחוס שנוסע בין שתי התחנות ב*כיוון הפוך* (B→A) לא ישמש יותר להוכחת עיקוף — ייתכן שהוא על רחובות חד-סטריים אחרים, ואורכו אינו מעיד על מסלול קצר בכיוון הנבדק. המקטע מסומן \"לא ניתן להשוואה\". (קווים 106/102 מול קו 262 שנוסע ת.מרכזית→עליאש; קו 33 מול 99א.)",
    "תוקן: \"לולאה\" מזוהה עכשיו רק כשהמסלול חוזר לאחור *וממשיך קדימה* (הלוך-חזור ממשי). נסיגה בקצה המקטע בעת גישה לתחנה/מסוף (ארטיפקט-הטלה על הקו הישר) אינה נספרת יותר כלולאה — מנע סימון-שווא של עיקוף. (קו 106: \"נסיגה\" 241 מ' בגישה לתחנה המרכזית, ללא לולאה אמיתית.)",
  ] },
  { version: "1.3.8", date: "13.6.2026", items: [
    "תוקן: עיקוף שבו הקו חוזר לאחור על צירו (לולאה/הלוך-חזור ≥150 מ') מסומן עכשיו \"אמיתי\" גם כשקו-הייחוס מגיע מכיוון-הגעה שונה — המדידה מתחילה מתחנת-התקלה עצמה ולא מהתחנה הקודמת. כיוון-הגעה שונה אינו יכול לייצר נסיגה-עצמית כזו. (קו 110: לולאה 162 מ', נוסע פי 2 מקו 217.)",
    "כשההשוואה נקייה (אותו זוג-תחנות עוקב, אותו ציר-כניסה) ויחס המרחקים ≥1.35 — המקטע מסומן \"אמיתי\" גם אם הבליטה-הצידית דומה לקו-הייחוס. \"מבנה כביש משותף\" חל רק כשהיחס קרוב ל-1.0. (קו 86: נוסע פי 1.4 מקו 716 על אותו מקטע.)",
