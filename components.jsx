...
const CHANGELOG = [
  { version: "4.2", date: "16.6.2026", items: [
    "חיפוש עיר ב\"כל הארץ\": מקלידים שם-עיר (בחיפוש הראשי או בתוך החלון) ומקבלים מיד את כל העיקופים של אותה עיר מהדוח המוכן — כולל הבזבוז היומי, ולחיצה להצגה על המפה — *בלי להעלות קובץ GTFS*. חיפוש-העיר זמין מיד עם פתיחת החלון.",
  ] },
