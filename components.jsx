...
function fmtRd(rd) {
  ...
  const alt = (p[2] === "#" || p[2] === "0") ? "ראשית" : p[2];
  return `כיוון ${p[1]} · חלופה ${alt} · מק״ט ${p[0].replace(/^0+/, "")}`;
}
...
const CHANGELOG = [
  { version: "4.9", date: "4.8.2026", items: [
    ...
    "הסריקה הארצית רצה מעכשיו כל לילה (06:00 שעון ישראל) במקום פעם בשבוע — קובץ הנתונים של משרד התחבורה מתחדש יומית, אז גם הדוח (בקשת משתמש).",
