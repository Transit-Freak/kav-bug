...
const CHANGELOG = [
  { version: "4.6", date: "6.7.2026", items: [
    ...
    "נוסף זיהוי למקטעי \"חשד עיקוף (רק לפי רכב)\" שצורתם חוזרת כמעט לאותה נקודה שממנה יצאו לפני שממשיכים הלאה — סימן לגישה לתחנת-קצה בדרך-ללא-מוצא (כמו בית-חולים) ולא עיקוף-צד רגיל. ההסבר מציין זאת במפורש. בבדיקה מתברר שזה חל על רוב המקטעים בקטגוריה הזו (כ-70%) — כדאי להביא בחשבון בבדיקה הידנית.",
  ] },
