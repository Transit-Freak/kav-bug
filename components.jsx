...
const KAVBUG_VERSION = "3.14";

// יומן שינויים — מוצג בלחיצה על מספר הגרסה. הראש = הגרסה הנוכחית.
const CHANGELOG = [
  { version: "3.14", date: "13.6.2026", items: [
    "גלאי הלולאה לא יסמן יותר \"סיבוב מיותר\" כשקו-ההשוואה מגיע לתחנה מכיוון אחר לגמרי (סטייה >60° בזווית-ההגעה). במצב כזה הסיבוב הוא תמרון-היפוך הכרחי הנובע מכיוון-הנסיעה של הקו — לא בזבוז שאפשר ליישר.",
  ] },
