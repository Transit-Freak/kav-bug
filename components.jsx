...
const CHANGELOG = [
  { version: "4.2", date: "16.6.2026", items: [
    ...
    "במפה (תצוגת \"כל הארץ\"): כשרק חלק מהמקטע בזבזני — הקו עוקב אחרי המסלול ואז עושה הלוך-חזור או בליטה קצרה — מסומן בכתום *רק החלק המיותר*, לא כל הקטע מתחנה לתחנה. כשכל המקטע הוא העיקוף (לולאה שלמה) הוא עדיין מסומן במלואו. כך התצוגה תואמת לתצוגת-העיר.",
  ] },
