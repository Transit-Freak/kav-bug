...
const KAVBUG_VERSION = "1.3.1";

// יומן שינויים — מוצג בלחיצה על מספר הגרסה. הראש = הגרסה הנוכחית.
const CHANGELOG = [
  { version: "1.3.1", date: "10.6.2026", items: [
    "תיקון גלאי הסיבוב: מוגבל למקטעים עירוניים קצרים בלבד (מנע התראת-שווא של 27 ק\"מ על מקטע בין-עירוני), ומסמן רק אם אף קו אחר אינו עושה את אותו סיבוב בכיכר.",
  ] },
